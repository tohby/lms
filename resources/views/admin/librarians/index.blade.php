        ...
        <div class="py-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
                <div class="d-block mb-4 mb-md-0">
                    ...
                    <h2 class="h4">All Librarians</h2>
                </div>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="/admin/librarians/create" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <div class="table-settings mb-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col col-md-6 col-lg-3 col-xl-4">
                        <form id="librarians-search-form" action="{{ action('SearchController@students') }}" method="POST">
                            @csrf
                            <div class="input-group me-2 me-lg-3 fmxw-400">
                                ...
                                <input type="text" class="form-control" name="searchKey" placeholder="Search librarians"
                        ...
                        @foreach ($librarians as $librarian)
                            <div
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <a href="librarians/{{ $librarian->id }}/edit" class=" align-items-center fw-bold mr-3">
                                        Edit
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            @include('admin/librarians/delete')
                        @endforeach
                    </div>
                    <div
                        class="card-footer px-3 border-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
                        {{ $librarians->links() }}
                        <div class="fw-normal small mt-4 mt-lg-0">Showing <b>{{ $librarians->count() }}</b> out of
                            <b>{{ $totalCount }}</b>
                            entries
                        </div>
                    </div>
